...
export const Footer = () => {
  return (
        <footer className="bg-sky-800 dark:bg-gray-900">
            <div className="mx-auto w-full container p-4 sm:p-6">
                  ...
                  <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                      <div>
                          ...
                          <ul className="text-gray-600 dark:text-gray-400 font-medium">
                              <li>
                                  <a href="https://legacy.reactjs.org/docs/getting-started.html" target="_blank" rel="noreferrer" className="hover:underline text-white">React JS</a>
                              </li>
                              <li>
                                  <a href="https://tailwindcss.com/docs/installation" target="_blank" rel="noreferrer" className="hover:underline text-white">Tailwind CSS</a>
                              </li>
                              <li>
                                  <a href="https://www.themoviedb.org/" target="_blank" rel="noreferrer" className="hover:underline text-white">MovieDB API</a>
                              </li>
                          </ul>
                      </div>
                      <div>
                          ...
                          <ul className="text-gray-600 dark:text-gray-400 font-medium">
                              <li className="mb-4">
                                  <a href="https://github.com/RubenSH51" target="_blank" rel="noreferrer" className="hover:underline  text-white">Github</a>
                              </li>
                          </ul>
                      </div>
                      <div>
              ...
              <div className="sm:flex sm:items-center sm:justify-between">
                  <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="/filmflux" className="hover:underline">FilmFlux</a>. All Rights Reserved.
                  </span>
                  <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                      <a href="https://www.facebook.com" target="_blank" rel="noreferrer" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                      ...
                      <a href="https://www.twitter.com" target="_blank" rel="noreferrer" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                      ...
                      <a href="https://github.com/RubenSH51" target="_blank" rel="noreferrer" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
